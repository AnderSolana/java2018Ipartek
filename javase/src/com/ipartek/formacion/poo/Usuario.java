...
public class Usuario {
	...
	// Public: Acceso total
	// Protected: Privado pero disponible para toda la herencia y para el paquete en el que
	// está
	// Package: Visible para las clases del mismo paquete, es la que viene por defecto,
	// es decir, si no especificamos nada, se nos pondrá esta. 
	// Private: Solo en la propia clase se podrá acceder
	...
	public static void setContadorDeInstancias(int contadorDeInstancias) {
		Usuario.contadorDeInstancias = contadorDeInstancias;
	}
